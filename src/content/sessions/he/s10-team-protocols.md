...
challenge:
  text: "ממשו זרימת אישור תוכנית: המוביל מציע תוכנית, חבר צוות בודק ומאשר או דוחה."
  hint: "השתמשו בסוגי הודעות `REQUEST`/`RESPONSE` עם שדה `\"plan\"`"
---

## הבעיה

בסשן [צוותי הסוכנים](/he/s09-agent-teams), חברי הצוות עובדים ומתקשרים אבל חסר להם תיאום מובנה:
...
## מה השתנה מ-[צוותי סוכנים](/he/s09-agent-teams)
