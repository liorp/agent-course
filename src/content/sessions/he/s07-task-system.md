...
שמירת משימות לדיסק היא מה שהופך את תוכניות הסוכן לעמידות. גרף המשימות מקודד לא רק *מה* לעשות אלא *באיזה סדר* ו*מה יכול לרוץ במקביל*. בשילוב עם דחיסת הקשר, הסוכן יכול לעבוד על מטרות גדולות באמת לאורך סיבובים רבים מבלי לאבד עקב.
