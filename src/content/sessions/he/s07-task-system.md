...
challenge:
  text: "צרו גרף משימות עם 5+ משימות ולפחות 2 שרשראות תלויות. הריצו get_ready_tasks כדי לראות מה יכול לרוץ."
  hint: "השתמשו ב-add_dependency לקישור משימות, ואז בדקו לאילו כל התלויות מסופקות"
---
