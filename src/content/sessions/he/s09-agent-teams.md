...
beginnerConcepts:
  - question: "במה חבר צוות שונה מתת-סוכן?"
    answer: "תת-סוכן (s04) הוא חד-פעמי — נולד, עובד, מחזיר סיכום, מת. לחבר צוות יש זהות מתמשכת, מחזור חיים (IDLE, WORKING, SHUTDOWN), ותיבת דואר שהוא בודק בין משימות. חברי צוות זוכרים את תפקידם לאורך הפעלות."
...
תת-סוכנים (s04) הם חד-פעמיים: נולדים, עובדים, מחזירים סיכום, מתים. אין זהות, אין זיכרון בין הפעלות. משימות רקע (s08) מריצות פקודות shell אבל לא יכולות לקבל החלטות מודרכות על ידי LLM.
