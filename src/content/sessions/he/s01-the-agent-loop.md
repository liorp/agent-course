...
הסוד השלם של סוכן קוד מבוסס AI הוא הלולאה הזו. המודל הוא הבינה — הוא מחליט מה לעשות. הקוד הוא הרתמה — הוא נותן למודל כלי ומזין חזרה תוצאות. בסשן הבא, נוסיף עוד כלים מבלי לשנות את הלולאה כלל.
